...
if ( (isset($_POST['login']) && isset($_POST['password'])) && (!empty($_POST['login']) && !empty($_POST['password'])) )
{
   ...
   {
      // Если нужные поля есть, продолжаем трансфер домена
      try 
      {         
      ...
      {
         // Не удалось вызвать функцию domainCnoTransfer на сервере или она отработала неправильно.
      ...
      {
         // функция отработала, возникла обработанная ошибка с идентификатором $domaintransfer->status->name, выдаем сообщение.
      ...
      {
         // Успешно поставили задание на трансфер домена в очередь с идентификатором задания $domaintransfer->taskid
