        ...
        <div class="card-body">
            <div class="form-row">
                <div class="form-group col-md-8">
                    <label for="search">Быстрый фильтр</label>
                    <input id="search"
                           type="text"
                           class="form-control"
                           placeholder="например: group_id или message_new"
        ...
        <table class="table table-sm table-bordered table-striped">
            ...
            @forelse($rows as $index => $line)
                <tr>
                    ...
                    <td style="white-space: pre-wrap; font-family: Consolas, Monaco, monospace; word-break: break-all; font-size: 12px;">{{ $line }}</td>
                </tr>
            @empty
                <tr>
