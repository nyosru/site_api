...
if ( (isset($_POST['login']) && isset($_POST['password'])) && (!empty($_POST['login']) && !empty($_POST['password'])) )
{
   ...
   if (isset($_POST['nic_hdl']))
   {
      ...
      {         
         ...
         $adddadmin_result = $client->addDadminPerson( $_POST['nic_hdl'],    iconv("KOI8-R", "UTF-8", $_POST['fiorus']),
      ...
      {
         // Не удалось вызвать функцию addDadminPerson на сервере или она отработала неправильно.
         echo $format1."Couldnt execute addDadminPerson".$format2;
         echo "Fault code: ".$fault->faultcode."<br>Fault message: ".$fault->faultstring;
         logout();
         exit();
      }
      ...
      {
         // Успешно добавили нового администратора доменов - физлицо.
         echo "<br><b>addDadminPerson message:</b> ".$adddadmin_result->status->message; 
         echo "<br><b>Returned nic-hdl:</b> ".$adddadmin_result->nic_hdl; 
         echo "<br><br>".$client->__getLastRequest();
         echo "<br><br>".iconv("KOI8-R", "UTF-8", $_POST['postal_addr']);
      }
   }
   else
   {
