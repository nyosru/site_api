...
if ( (isset($_POST['login']) && isset($_POST['password'])) && (!empty($_POST['login']) && !empty($_POST['password'])) )
{
   ...
   try 
   {  
      // получим список регистраторов   
      $_POST['zone'] = iconv('UTF-8','KOI8-R',$_POST['zone']);
      $registrars = $client->getRegistrars($_POST['zone'],$_POST['service']);
   }
   catch(SoapFault $fault)
   {
      // Не удалось вызвать функцию getRegistrars на сервере или она отработала неправильно.
   ...
   {
      // функция отработала, возникла обработанная ошибка с идентификатором $registrars->status->name, выдаем сообщение.
