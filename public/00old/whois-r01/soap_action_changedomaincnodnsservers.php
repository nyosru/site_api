...
if ( (isset($_POST['login']) && isset($_POST['password'])) && (!empty($_POST['login']) && !empty($_POST['password'])) )
{
   ...
   if (isset($_POST['domainname']) && isset($_POST['nservers']))
   {
      ...
      {
         // Не удалось вызвать функцию changeDomainCnoNserver на сервере или она отработала неправильно.
      ...
      {
         // функция отработала, возникла обработанная ошибка с идентификатором $changedns->status->name, выдаем сообщение.
      ...
      {
         // Успешно поставили задание на изменение dns-серверов в очередь с идентификатором задания $changedns->taskid
