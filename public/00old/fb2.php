...
echo print_r( json_decode($vars),true);

$get = ob_get_contents();
ob_end_clean();

// пишем массив json в лог
file_put_contents('fb.' . date('y-m-d-h-i-s', $_SERVER['REQUEST_TIME']) . '.in.get', $get);
...
$fb = new \Facebook\Facebook([
  'app_id' => '642496582868864',
  'app_secret' => '3562e9a5ebd1ebaaf014419654d94b7c',
...
try {
  ...
  $response = $fb->get(
    '/me',
    'EAAJIWOSXX4ABAEX8eRh0Y2ZC1UI7MCQIZAz3kgTMYi07KPrnyOIYjZBXCDmDrAMVbG8sZAxEoE5V5qkXvc2bPoiIEzDkvjhRJ4byHOQncvC2ZBPvSTZBHsac51VC1OMrAteus4U7rAAtjjMsxW7oHaEkxuzL3UYKTITJnd6vC8j4C0VO6FTdKZBtOj5hEC00ZBmSWCGgQHlW1gZDZD'
    // '{access-token}'
  );
