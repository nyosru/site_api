...
class VkWebhookLogComponent extends Component
{
    use WithPagination;
    ...
    {
        $path = storage_path('logs/vk-webhook.log');

        if (is_file($path) && is_writable($path)) {
            file_put_contents($path, '');
            $this->statusMessage = 'Лог VK вебхуков очищен.';
        } else {
            $this->statusMessage = 'Лог-файл не найден или недоступен для записи.';
        }
    ...
    public function render()
    {
        ...
        return view('livewire.vk-webhook-log-component', [
            'rows' => $rows,
