...
<main role="main">
    <section class="jumbotron text-center">
        <div class="container">
            ...
            <p>
                <a href="https://php-cat.com" target="_blank" class="btn btn-primary my-2">Заказать создание сайта</a>
                <a href="https://php-cat.com" target="_blank" class="btn btn-secondary my-2">Записаться на
                    консультацию</a>
            </p>
        </div>
    </section>
